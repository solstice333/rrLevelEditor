...
Header* Editor::readHeader() {
   ...
   int check = fscanf(file, "%d %d %d %d", &headerInfo->bg_w, &headerInfo->bg_h,
...
Figure* Editor::decodeFigure() {
   ...
   case rectBoundaryFigure: {
      newFig = new RectBoundaryFigure(x, y, *mysurf, SDL_GetVideoSurface(),
            lvlWidth, lvlHeight, numClips);
      break;
   }
   case circBoundryFigure: {
      newFig = new CircBoundaryFigure(x, y, *mysurf, SDL_GetVideoSurface(),
            lvlWidth, lvlHeight, numClips);
      break;
   }
   ...
   case tempFigure: {
      newFig = new TempFigure(x, y, *mysurf, SDL_GetVideoSurface(), lvlWidth,
            lvlHeight);
      break;
   }
   case cursorFigure: {
