...
class Figure {
	...
	/*
	 * Variables and methods needed for the Editor to work it's Magic
	 * Conditions Required for creation
	 */
	 ...
	 */
	virtual void resolveCollision(Figure* other, double timeStep,
			Component dir);
